...
// first line is the start, second line is the solved board, extend this !!!
...
function startGame() {
  ...
  // Set lives equal to 3 and enable selecting numbers and tiles
  lives = 3;
  disableSelect = false;
...
function startTimer() {
  // Sets time remaining base on input
...
function checkCorrect(tile) {
  ...
  // if tile's numbe ris equal to solution's number
